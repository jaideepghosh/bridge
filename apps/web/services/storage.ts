...
export class LocalStorageProvider {
      ...
      const environments: Environment[] = [
        {
          ...
          variables: [
            ...
            },
            {
              id: uuidv4(),
              key: "ACCESS_TOKEN",
              initialValue: "dev_token_123",
              currentValue: "dev_token_123",
              enabled: true,
              isSecret: true,
            },
          ],
        ...
        },
        {
          ...
          variables: [
            ...
            },
            {
              id: uuidv4(),
              key: "ACCESS_TOKEN",
              initialValue: "prod_token_456",
              currentValue: "prod_token_456",
              enabled: true,
              isSecret: true,
            },
          ],
  ...
  getCollections(): Collection[] {
    return this.getItems<Collection>(STORAGE_KEYS.COLLECTIONS);
  }
  ...
  // Folders
  getFolders(): Folder[] {
    return this.getItems<Folder>(STORAGE_KEYS.FOLDERS);
  }
  ...
  getRequests(): SavedRequest[] {
    return this.getItems<SavedRequest>(STORAGE_KEYS.REQUESTS);
  }
  ...
  getExamples(): ApiExample[] {
    return this.getItems<ApiExample>(STORAGE_KEYS.EXAMPLES);
  }
  ...
  getEnvironments(): Environment[] {
    return this.getItems<Environment>(STORAGE_KEYS.ENVIRONMENTS);
  }
